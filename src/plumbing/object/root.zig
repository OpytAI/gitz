...
pub const getCommitFromGetter = commit_mod.getCommitFromGetter;
...
pub const PathFilterCtx = walker_mod.PathFilterCtx;
...
pub const newCommitPathIterFromIterCtx = walker_mod.newCommitPathIterFromIterCtx;
